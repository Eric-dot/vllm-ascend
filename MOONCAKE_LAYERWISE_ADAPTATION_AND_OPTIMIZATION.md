...
- Local working branch: `eric-mooncake-pr12418-port-pp-dcp`.
...
- Base: `Eric-dot/vllm-ascend:eric-mooncake-pr12418-port` at `a3dc7ef963c21607f67dc76722503537ba73a72b`.
- Focused AscendStore CPU mock regression: `290 passed, 110 subtests passed`, including the new parallel tests.
